        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-sm">
              Simplifying rental property management for tenants, landlords, and property managers worldwide.
            </p>
            ...
            <div className="space-y-2">
              <div className="flex items-center text-sm text-muted-foreground">
                ...
                <a href="mailto:support@rentmate.com" className="hover:text-primary transition-colors">
                  Rmit@rmit.edu.vn
                </a>
              </div>
              <div className="flex items-center text-sm text-muted-foreground">
              ...
              <div className="flex items-center text-sm text-muted-foreground">
                ...
                <span>521 Kim Ma, Ngoc Khanh, Ha Noi</span>
              </div>
            </div>
          </div>
